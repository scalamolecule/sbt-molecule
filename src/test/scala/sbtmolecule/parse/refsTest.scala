...
import sbtmolecule.db.resolvers.{Db_MySQL, Db_SQlite}
import utest.*
        ...
        MetaDomain("sbtmolecule.parse", "refs", List(
          MetaSegment("", List(
            ...
            MetaEntity("G", List(
              ...
              MetaAttribute("Hh", SetValue, "ID"    , Nil, Some("H"), Some("g"), Some(OneToMany), None, List("owned"), None, Nil, Nil, Nil, None)
            ...
            MetaEntity("H", List(
              ...
              MetaAttribute("i" , OneValue, "Int"   , Nil, None, None, None, None, Nil, None, Nil, Nil, Nil, None),
              MetaAttribute("s" , OneValue, "String", Nil, None, None, None, None, Nil, None, Nil, Nil, Nil, None),
              MetaAttribute("g" , OneValue, "ID"    , Nil, Some("G"), Some("Hh"), Some(ManyToOne), None, List("owner"), None, Nil, Nil, Nil, None),
...
//      println(Db_MySQL(generator.metaDomain).getSQL)
