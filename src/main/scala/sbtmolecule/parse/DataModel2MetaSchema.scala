...
class DataModel2MetaSchema(filePath: String, pkgPath: String, scalaVersion: String) extends BaseHelpers {
  ...
  private def acc(pp: String, ns: String, t: Tree, a: MetaAttr): MetaAttr = {
    ...
    t match {
      ...
      case q"arrayString"         => a.copy(card = CardArr, baseTpe = "String")
      case q"arrayInt"            => a.copy(card = CardArr, baseTpe = "Int")
      case q"arrayLong"           => a.copy(card = CardArr, baseTpe = "Long")
      case q"arrayFloat"          => a.copy(card = CardArr, baseTpe = "Float")
      case q"arrayDouble"         => a.copy(card = CardArr, baseTpe = "Double")
      case q"arrayBoolean"        => a.copy(card = CardArr, baseTpe = "Boolean")
      case q"arrayBigInt"         => a.copy(card = CardArr, baseTpe = "BigInt")
      case q"arrayBigDecimal"     => a.copy(card = CardArr, baseTpe = "BigDecimal")
      case q"arrayDate"           => a.copy(card = CardArr, baseTpe = "Date")
      case q"arrayDuration"       => a.copy(card = CardArr, baseTpe = "Duration")
      case q"arrayInstant"        => a.copy(card = CardArr, baseTpe = "Instant")
      case q"arrayLocalDate"      => a.copy(card = CardArr, baseTpe = "LocalDate")
      case q"arrayLocalTime"      => a.copy(card = CardArr, baseTpe = "LocalTime")
      case q"arrayLocalDateTime"  => a.copy(card = CardArr, baseTpe = "LocalDateTime")
      case q"arrayOffsetTime"     => a.copy(card = CardArr, baseTpe = "OffsetTime")
      case q"arrayOffsetDateTime" => a.copy(card = CardArr, baseTpe = "OffsetDateTime")
      case q"arrayZonedDateTime"  => a.copy(card = CardArr, baseTpe = "ZonedDateTime")
      case q"arrayUUID"           => a.copy(card = CardArr, baseTpe = "UUID")
      case q"arrayURI"            => a.copy(card = CardArr, baseTpe = "URI")
      case q"arrayByte"           => a.copy(card = CardArr, baseTpe = "Byte")
      case q"arrayShort"          => a.copy(card = CardArr, baseTpe = "Short")
      case q"arrayChar"           => a.copy(card = CardArr, baseTpe = "Char")

      case q"arrayString(${Lit.String(s)})"         => a.copy(card = CardArr, baseTpe = "String", description = Some(s))
      case q"arrayInt(${Lit.String(s)})"            => a.copy(card = CardArr, baseTpe = "Int", description = Some(s))
      case q"arrayLong(${Lit.String(s)})"           => a.copy(card = CardArr, baseTpe = "Long", description = Some(s))
      case q"arrayFloat(${Lit.String(s)})"          => a.copy(card = CardArr, baseTpe = "Float", description = Some(s))
      case q"arrayDouble(${Lit.String(s)})"         => a.copy(card = CardArr, baseTpe = "Double", description = Some(s))
      case q"arrayBoolean(${Lit.String(s)})"        => a.copy(card = CardArr, baseTpe = "Boolean", description = Some(s))
      case q"arrayBigInt(${Lit.String(s)})"         => a.copy(card = CardArr, baseTpe = "BigInt", description = Some(s))
      case q"arrayBigDecimal(${Lit.String(s)})"     => a.copy(card = CardArr, baseTpe = "BigDecimal", description = Some(s))
      case q"arrayDate(${Lit.String(s)})"           => a.copy(card = CardArr, baseTpe = "Date", description = Some(s))
      case q"arrayDuration(${Lit.String(s)})"       => a.copy(card = CardArr, baseTpe = "Duration", description = Some(s))
      case q"arrayInstant(${Lit.String(s)})"        => a.copy(card = CardArr, baseTpe = "Instant", description = Some(s))
      case q"arrayLocalDate(${Lit.String(s)})"      => a.copy(card = CardArr, baseTpe = "LocalDate", description = Some(s))
      case q"arrayLocalTime(${Lit.String(s)})"      => a.copy(card = CardArr, baseTpe = "LocalTime", description = Some(s))
      case q"arrayLocalDateTime(${Lit.String(s)})"  => a.copy(card = CardArr, baseTpe = "LocalDateTime", description = Some(s))
      case q"arrayOffsetTime(${Lit.String(s)})"     => a.copy(card = CardArr, baseTpe = "OffsetTime", description = Some(s))
      case q"arrayOffsetDateTime(${Lit.String(s)})" => a.copy(card = CardArr, baseTpe = "OffsetDateTime", description = Some(s))
      case q"arrayZonedDateTime(${Lit.String(s)})"  => a.copy(card = CardArr, baseTpe = "ZonedDateTime", description = Some(s))
      case q"arrayUUID(${Lit.String(s)})"           => a.copy(card = CardArr, baseTpe = "UUID", description = Some(s))
      case q"arrayURI(${Lit.String(s)})"            => a.copy(card = CardArr, baseTpe = "URI", description = Some(s))
      case q"arrayByte(${Lit.String(s)})"           => a.copy(card = CardArr, baseTpe = "Byte", description = Some(s))
      case q"arrayShort(${Lit.String(s)})"          => a.copy(card = CardArr, baseTpe = "Short", description = Some(s))
      case q"arrayChar(${Lit.String(s)})"           => a.copy(card = CardArr, baseTpe = "Char", description = Some(s))
